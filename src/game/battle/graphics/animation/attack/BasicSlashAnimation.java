 ...
 * @author Dave
 */
public class BasicSlashAnimation extends AbstractAnimation {
    ...
    public BasicSlashAnimation(Sword sword) {
        this.sword = sword;
    ...
    public void update(float tpf) {
        if (disable) {
            ...
            if (rotationDegrees > rotationAmount) {
                sword.rotate(0, 0, -FastMath.DEG_TO_RAD * rotationDegrees);
                rotationDegrees = 0;
